...
def setUp() {
	String sql = "update master_testcases set tc_run_status = 'Running', tc_result = '' where tc_id = 1003"
...
def tearDown() {
	String sql = "update master_testcases set tc_run_status = 'Executed' where tc_id = 1003" 
